...
* [SynCommons](https://github.com/synopse/mORMot/blob/master/SynCommons.pas?raw=true). High speed JSON library, using `TDocVariant` custom variant type for storage and access.
